...
$select="SELECT * FROM `freelancer` JOIN `project member`
 ON `freelancer`.`freelancer_id`=`project member`.`member_id`
  JOIN `project` ON `project`.`project_id`=`project member`.`project_id`
   WHERE `freelancer_id`='$freelancer_id' AND `project member`.`status`='done'";
...
<body>
 ...
 <?php foreach($run as $data){?>
            ...
            <div class="card">
                ...
                <h2>Project Name: <p><?php echo $data['project_name']?></p></h2>
                <br>
            
                <h2>Description: <p  class="dscription"><?php echo $data['descriptionP']?></p></h2>
                <br>
                <h2>Hours: <p><?php echo $data['hours']?></p></h2>
                <br>
                <h2>Type: <p><?php echo $data['type']?></p></h2>
                <br>
