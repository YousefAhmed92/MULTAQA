...
// $updatedValue=$_SESSION['countproject'];
...
<body>
    ...
    <div class="div-container">
        <div class="main-div">
            ...
            <div class="img-div">
                <?php if(empty($image)){ ?>
                <img class="img-pro" src="img/profile.png"alt="Freelancer Image">
<?php } else { ?>
                <img class="img-pro" src="img/<?php echo htmlspecialchars($image); ?>"alt="Freelancer Image">
                <?php } ?>
            </div>
